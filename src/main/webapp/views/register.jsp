						...
						<div class="card-body p-md-4">
							<div class="row justify-content-center">
								<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
									...
									<p class="text-center h4 fw-bold mb-3 mx-1 mx-md-4">ĐĂNG KÝ</p>

									<form class="mx-1 mx-md-4" action="/webhan/register"
										method="post">
										...
										<div>Đã có tài khoản? <a href="/webhan/login">Đăng nhập</a></div>
									</form>
